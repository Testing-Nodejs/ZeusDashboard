...
const ImportFromExcel = () => {
  ...
  const AddEmp = () => {
    ...
    console.log(obj);
    axios
      .post(MyApiUrl + "importproducts", obj)
  ...
  return (
    <div>
      ...
      <h1 id="ccmaster">Import Products From Excel</h1>
            ...
            <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
              <CCardBody>
                <CRow>
                  <CCol>
                    <CCard>
                      <CCardHeader style={{ fontSize: "14px" }}>Import Products From Excel</CCardHeader>
                      <CCardBody>
                        <CForm
                          action=""
                          method="post"
