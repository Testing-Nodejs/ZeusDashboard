...
const TentativeOrders = () => {
    ...
    const GetAllScheduledOrder = () => {
        ...
        axios({
            method: "GET",
            url: MyApiUrl + "getAllTentativeOrders",
            headers: {
                "content-type": "application/json",
            },
        })
            .then((response) => {
                const items = response.data.map((item, index) => {
                    return {
                        ...
                        "Tentative Date": item.ORDER_TENTATIVE_DATE,
                    };
                });
    ...
    const SendToInvoice = (pkid) => {
        document.getElementById("divLoading").className = "show";
        axios
            .put(MyApiUrl + "ConfirmForBatchNumbers/" + pkid)
            .then((response) => {
                if (response.data === true) {
                    Swal.fire({
                        title: "Batch Numbers Updated",
                        icon: "success",
                    ...
                    Swal.fire({
                        title: "Failed To Update Batch Number",
                        icon: "error",
                        confirmButtonText: "OK",
                    });
                    document.getElementById("divLoading").className = "hide";
    ...
    const FilterDates = () => {
        if (fromDate === "" || fromDate == null) {
            ...
            axios({
                method: "GET",
                url: MyApiUrl + "getAllTentativeOrdersByDate/" + fromDate + "/" + toDate,
                headers: {
                    "content-type": "application/json",
                },
            })
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Tentative Date Confirmed Orders</h1>
                                                    ...
                                                    <CSelect
                                                        ...
                                                        onChange={(event) => {
                                                            ...
                                                            axios({
                                                                ...
                                                                url:
                                                                    MyApiUrl +
                                                                    "/getAllTentativeOrdersBySupplyType/" +
                                                                    event.target.value,
                                                                headers: {
                                                                    "content-type": "application/json",
                                                                },
                ...
                <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardBody>
                            <CRow>
                                <CCol>
                                    <CCard>
                                        <CCardHeader>Tentative Orders</CCardHeader>
                                        <CCardBody>
                                            <CDataTable
                                                items={ResponseData}
                                                fields={fields2}
...
export default TentativeOrders;
