...
const ViewRejectedCustomer = () => {
    ...
    const GetAllCustomers = () => {
        ...
        axios({
            method: "GET",
            url: MyApiUrl + "getRejectCustomersReqs",
            headers: {
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Rejected Customers</h1>
                    ...
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardBody>
                            <CRow>
                                <CCol>
                                    <CCard>
                                        <CCardHeader>All Rejected Customers</CCardHeader>
                                        <CCardBody>
                                            <CDataTable
                                                items={ResponseData}
                                                fields={fields2}
                                                ...
                                                scopedSlots={{
                                                    ...
                                                    Status: () => (
                                                        <td>
                                                            <p className="RejectBadge">Denied</p>
                                                        </td>
                                                    ),
                                                    Address: (item) => (
                                                        <td>
...
export default ViewRejectedCustomer;
