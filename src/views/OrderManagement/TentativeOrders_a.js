...
const TentativeOrders_a = () => {
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Tentative Dispatched Date Confirmed Orders</h1>
                                        ...
                                        <CCardBody>
                                            <CDataTable
                                                ...
                                                scopedSlots={{
                                                    Status: (i) => (
                                                        <td>
                                                            <span className="ScheduledOrders">Tentative Orders</span>
                                                        </td>
                                                    ),
                                                    "Ordered Date": (i) => (
...
export default TentativeOrders_a;
