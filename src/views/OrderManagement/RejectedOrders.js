...
const RejectedOrders = () => {
  ...
  const GetRejectedOrders = () => {
    ...
    axios({
      method: "GET",
      url: MyApiUrl + "GetRejectedOrders",
      headers: {
        "content-type": "application/json",
      },
    })
  ...
  const FilterDates = () => {
    if (fromDate === "" || fromDate == null) {
      ...
      axios({
        method: "GET",
        url: MyApiUrl + "GetRejectedOrdersByDate/" + fromDate + "/" + toDate,
        headers: {
          "content-type": "application/json",
        },
      })
  ...
  return (
    <div id="city">
      ...
      <h1 id="ccmaster">View Rejected Orders</h1>
          ...
          <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
            <CCardBody>
              <CRow>
                <CCol>
                  <CCard>
                    <CCardHeader>Rejected Orders</CCardHeader>
                    <CCardBody>
                      <CDataTable
                        items={ResponseData}
                        fields={fields2}
