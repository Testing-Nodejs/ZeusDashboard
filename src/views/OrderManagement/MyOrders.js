...
const MyOrders = () => {
  ...
  const FilterDates = () => {
    if (fromDate === "" || fromDate == null) {
      ...
      axios({
        method: "GET",
        url: MyApiUrl + "GetAdminOrdersByDate/" + fromDate + "/" + toDate,
        headers: {
          "content-type": "application/json",
        },
      })
  ...
  return (
    <div id="city">
      ...
      <h1 id="ccmaster">Admin Orders</h1>
          ...
          <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
            <CCardBody>
              <CRow>
                <CCol>
                  <CCard>
                    <CCardHeader>Admin Placed Orders</CCardHeader>
                    <CCardBody>
                      <CDataTable
                        items={ResponseData}
                        fields={fields2}
