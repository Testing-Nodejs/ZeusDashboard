...
const Distributor_MyOrders = () => {
  ...
  return (
    <div id="city">
      ...
      <h1 id="ccmaster">Distributor Orders</h1>
                          ...
                          <CSelect
                            ...
                            onChange={(event) => {
                              ...
                              axios({
                                ...
                                url:
                                  MyApiUrl +
                                  "/getOrdersByDistributerBySupplyType/" +
                                  event.target.value +
                                  "/" +
                                  DistributerID,
                                headers: {
        ...
        <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
            <CCardBody>
              <CRow>
                <CCol>
                  <CCard>
                    <CCardHeader>Your Orders</CCardHeader>
                    <CCardBody>
                      <CDataTable
                        items={ResponseData}
                        fields={fields2}
...
export default Distributor_MyOrders;
