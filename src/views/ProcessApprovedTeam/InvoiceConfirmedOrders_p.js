...
const InvoiceConfirmedOrders_p = () => {
    ...
    const GetAllScheduledOrder = () => {
        ...
        axios({
            method: "GET",
            url: MyApiUrl + "getAllConfirmForInvoiceOrders",
            headers: {
                "content-type": "application/json",
            },
        })
    ...
    const FilterDates = () => {
        if (fromDate === "" || fromDate == null) {
            ...
            axios({
                method: "GET",
                url: MyApiUrl + "getAllConfirmForInvoiceOrdersByDate/" + fromDate + "/" + toDate,
                headers: {
                    "content-type": "application/json",
                },
            })
    ...
    const ConfirmOrder = () => {
        ...
        var obj = {
            ...
            ORDER_INVOICE_DOC: InvoiceDoc,
        };
        axios.put(MyApiUrl + "UploadInvoice/" + OrderPkid + "", obj).then((response) => {
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Invoice Confirmed Orders</h1>
                                                    ...
                                                    <CSelect
                                                        ...
                                                        onChange={(event) => {
                                                            ...
                                                            axios({
                                                                ...
                                                                url:
                                                                    MyApiUrl +
                                                                    "/getAllConfirmForInvoiceOrdersBySupplyType/" +
                                                                    event.target.value,
                                                                headers: {
                                                                    "content-type": "application/json",
                                                                },
                                                    ...
                                                    <CSelect
                                                        ...
                                                        onChange={(event) => {
                                                            ...
                                                            axios({
                                                                ...
                                                                url:
                                                                    MyApiUrl +
                                                                    "/getAllConfirmForInvoiceOrdersByMonth/" +
                                                                    event.target.value,
                                                                headers: {
                                                                    "content-type": "application/json",
                                                                },
                ...
                <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardBody>
                            <CRow>
                                <CCol>
                                    <CCard>
                                        <CCardHeader>Invoice Confirmed Orders</CCardHeader>
                                        <CCardBody>
                                            <CDataTable
                                                items={ResponseData}
                                                fields={fields2}
            ...
            <CModal show={block4} onClose={() => setblock4(!block4)} color="dark">
                <CModalHeader closeButton>
                    <CModalTitle>Upload Invoice</CModalTitle>
                </CModalHeader>
                <CModalBody>
                    <CRow style={{ padding: "0% 5% 0% 5% !important" }}>
                        <CCol xs="12" md="12">
                            <CLabel> Invoice Upload</CLabel>
                            <CInput
                                type="file"
...
export default InvoiceConfirmedOrders_p;
