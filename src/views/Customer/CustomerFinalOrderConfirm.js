...
const CustomerFinalOrderConfirm = (props) => {
  ...
  const GetCustomerDetails = () => {
    ...
    axios({
      ...
      .then((response) => {
        setCustomerDetails({
          ...CustomerDetails,
          Cname: response.data.CUSTOMER_NAME,
          Cemail: response.data.CUSTOMER_EMAIL,
          Cpho: response.data.CUSTOMER_MOBILE,
          category: response.data.CUSTOMER_CATEGORY_NAME,
          type: response.data.CUSTOMER_TYPE_NAME,
          SubType: response.data.CUSTOMER_SUBTYPE_NAME,
          CustomerID: response.data.CUSTOMER_PKID,
          FirmName: response.data.CUSTOMER_FIRM_NAME,
          Capacity: response.data.CUSTOMER_CAPACITY,
          Superior: response.data.EMPLOYEE_NAME,
          Cemail2: response.data.CUSTOMER_EMAIL2,
          Cpho2: response.data.CUSTOMER_ALT_MOBILE,
        });
    ...
    if (SelectedAddress === "" || SelectedAddress == null) {
      ...
      axios.post(MyApiUrl + "placeOrder", obj).then((response) => {
        if (response.data === true) {
          ...
          document.getElementById("divLoading").className = "hide";
          history.push("/ViewCustomerOrders");
        } else {
          Swal.fire({
                            ...
                            <tr>
                              ...
                              <td style={{ borderRight: "1px solid #7e0103" }}>
                                ...
                                <tr>
                                  ...
                                  <td>{CustomerDetails.FirmName}</td>
                                </tr>
                                <tr>
                                  <th>
                                    <b>Capacity :</b>
...
export default CustomerFinalOrderConfirm;
