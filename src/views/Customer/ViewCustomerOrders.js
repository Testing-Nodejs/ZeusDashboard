...
const ViewCustomerOrders = () => {
  ...
  const GetAllPendingOrder = () => {
    ...
    axios({
      method: "GET",
      url: MyApiUrl + "getAllOrdersByCustomer/" + CustomerID,
      headers: {
  ...
  return (
    <div id="city">
      ...
      <h1 id="ccmaster">Customer Orders</h1>
                          ...
                          <CSelect
                            ...
                            onChange={(event) => {
                              ...
                              axios({
                                ...
                                url:
                                  MyApiUrl +
                                  "/getAllOrdersByCustomerBySupplyType/" +
                                  event.target.value +
                                  "/" +
                                  CustomerID,
                                headers: {
