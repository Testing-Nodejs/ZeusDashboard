...
const OrderItemByProductsUnit = (props) => {
  ...
  const UnitID = props.location.state.data.i.PRD_PACKAG_PKID;
  ...
  const GetEmployeeOrders = () => {
    axios({
      ...
      url:
        MyApiUrl +
        "/OrderItemsByProductAndCompanyWithUnit/" +
        CompanyID +
        "/" +
        PRODUCT_PKID +
        "/" +
  ...
  const FilterDates = () => {
    if (fromDate === "" || fromDate == null) {
      ...
      axios({
        method: "GET",
        url: MyApiUrl + "OrderItemsByProductAndCompanyWithUnitByDate/" + fromDate + "/" + toDate + "/" + CompanyID + "/" + PRODUCT_PKID + "/" + UnitID,
        headers: {
          "content-type": "application/json",
        },
      })
              ...
              <CRow>
                <CCol>
                  <CCard>
                    <CCardHeader>
                      <CRow>
                        <CCol col="4">Product Unit Wise Sale</CCol>
                        <CCol md="2">
                          <CLabel>From:</CLabel>
                          <CInput
                            type="date"
...
export default OrderItemByProductsUnit;
