...
const SalesReportEmployeeOrders = (props) => {
  console.log(props);
  ...
  const GetEmployeeOrders = () => {
    axios({
      method: "GET",
      url: MyApiUrl + "getOrdersDetailsFromByEmp/" + EmployeeID,
      headers: {
  ...
  const FilterDates = () => {
    if (fromDate === "" || fromDate == null) {
      ...
      axios({
        method: "GET",
        url: MyApiUrl + "getOrdersDetailsFromByEmpByDate/" + EmployeeID + "/" + fromDate + "/" + toDate,
        headers: {
          "content-type": "application/json",
        },
      })
  ...
  const ToExcel = () => {
    ...
    const fileName = "Employee Orders List.csv";
  ...
  return (
    <div>
      <h1 id="ccmaster">Employee Sales</h1>
      <br />
      <CRow>
        <CCol md="2" />
        <CCol md="12">
...
export default SalesReportEmployeeOrders;
